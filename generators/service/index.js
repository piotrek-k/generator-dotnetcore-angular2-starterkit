...
module.exports = yeoman.Base.extend({
    prompting: function () {
        ...
        this.log(yosay(
            "Let's build Angular2 service!"
            ));

        this.savedServiceDestination = this.config.get(STORAGE.dest);
        ...
        var prompts = [
            ...
            },
            {
                ...
                default: this.savedServiceDestination ? this.savedServiceDestination : "./src/Angular2Template/src/app/shared/"
            }
        ];
    ...
    writing: function () {
        ...
        for (var f in files) {
            ...
            this.fs.copyTpl(
                ...
                this.destinationPath(this.props.dstPath + "/" + (this.fileName.replace(this.stringToExchange, this.props.nameToLower))), {
